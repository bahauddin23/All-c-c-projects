...
int main(){
	...
	head = NULL;
	insertfirst(1,"Burger   ",23,12);
	insertend(2,"Pizza    ",13,20);
	insertend(3,"Hot Cake ",8,1.23);
	insertend(4,"Coffee   ",46,2.23);
	insertend(5,"Ice-Cream",46,1.23);
	insertend(6,"Sandwich ",34,5.23);
	insertend(7,"Grill    ",7,20.29);
	insertend(8,"Nun-Bread",121,12.13);
	insertend(9,"Cold Drinks",73,1.13);
	...
	if(get_food_choice == temp->data){
		...
		if(confirm == 1 ){
			...
			br(2);pre(4);    printf("Enter Choose from List : ");
