    ...
    do
{
	...
	{
	printf("  \n\n\n       STUDENT INFO MANAGEMENT SYSTEM !!!! LOGIN IS SUCCESSFUL");
...
struct student {
 ...
 while(1) {
     ...
     cout << "\n\t\t\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2 STUDENT INFO MANAGEMENT SYSTEM \xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2 ";
	 cout <<"\n\n                                          ";
     cout << "\n\n";
